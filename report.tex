...
\begin{document}
    ...
    \begin{figure}[H]
        \begin{center}
            ...
            \lstinputlisting[language=Bash, firstline=0, lastline=22, frame=single]{assets/leaveatip_cog.fuzzy}
    ...
    \begin{figure}[H]
        \begin{center}
            ...
            \lstinputlisting[language=Bash, firstline=0, lastline=30, frame=single]{assets/automatic-pilot.fuzzy}
